...
def fetch_financial_data(ticker, db_path):
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        # Fetching the analyst count for EPS and Revenue
...
def generate_forecast_charts_and_tables(ticker, db_path, charts_output_dir):
    ...
    historical_data, forecast_data, analyst_counts = fetch_financial_data(ticker, db_path)

    # Prepare combined data for plotting only once
    combined_data = prepare_data_for_plotting(historical_data, forecast_data)
